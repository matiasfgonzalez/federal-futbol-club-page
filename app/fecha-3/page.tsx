...
import { matchResults } from "@/data/match-results/fecha3";
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="mx-3 md:mx-5 flex flex-col items-center">
                  <div className="flex items-center gap-2 bg-gradient-to-r from-[#1b2f62] to-[#2348a7] text-white px-4 py-2 rounded-xl shadow-md">
                    <span className="text-lg md:text-xl font-bold">{match.score.split(' - ')[0]}</span>
                    <span className="text-white/50">-</span>
                    <span className="text-lg md:text-xl font-bold">{match.score.split(' - ')[1]}</span>
                  </div>
                </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gradient-to-r from-[#1b2f62] to-[#2348a7] hover:from-[#1b2f62] hover:to-[#2348a7]">
                ...
                <TableHead className="text-white font-semibold">Equipo</TableHead>
                <TableHead className="text-white font-semibold text-center">PJ</TableHead>
                <TableHead className="text-white font-semibold text-center hidden sm:table-cell">G</TableHead>
                <TableHead className="text-white font-semibold text-center hidden sm:table-cell">E</TableHead>
                <TableHead className="text-white font-semibold text-center hidden sm:table-cell">P</TableHead>
                <TableHead className="text-white font-semibold text-center hidden md:table-cell">GF</TableHead>
                <TableHead className="text-white font-semibold text-center hidden md:table-cell">GC</TableHead>
                <TableHead className="text-white font-semibold text-center">
                  <span className="bg-amber-400 text-[#1b2f62] px-2 py-1 rounded-lg text-xs font-bold">PTS</span>
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {zoneTable.map((team, index) => (
                ...
                >
                  ...
                  <TableCell className="text-center text-gray-600">{team.played}</TableCell>
                  <TableCell className="text-center text-gray-600 hidden sm:table-cell">{team.won}</TableCell>
                  <TableCell className="text-center text-gray-600 hidden sm:table-cell">{team.drawn}</TableCell>
                  <TableCell className="text-center text-gray-600 hidden sm:table-cell">{team.lost}</TableCell>
                  <TableCell className="text-center text-gray-600 hidden md:table-cell">{team.goalsFor}</TableCell>
                  <TableCell className="text-center text-gray-600 hidden md:table-cell">{team.goalsAgainst}</TableCell>
                  <TableCell className="text-center">
